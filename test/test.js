...
Jx.use('jxCodeParserAnchoredProvider', function (Parser) {
...
//Jx.use('jxCodeGrammarTokenizer', function (tokenizer) {
//
//   window.t = tokenizer;
//
//});

//Jx.use('jxCodeTokenizer', 'jxCodeParserAnchoredProvider', function (Tokenizer, Parser) {
